...
return [
	...
	'items' => [
		...
		'2' => [
			...
			'style' => [
				'.landing-block-card' => [
					0 => 'landing-block-card col-lg-4 landing-block-node-img g-min-height-350 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover js-animation fadeInUp landing-card g-bg-primary-opacity-0_9--after',
					1 => 'landing-block-card col-lg-4 landing-block-node-img g-min-height-350 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover js-animation fadeInUp landing-card g-bg-primary-opacity-0_9--after',
					2 => 'landing-block-card col-lg-4 landing-block-node-img g-min-height-350 g-bg-img-hero row no-gutters align-items-center justify-content-center u-bg-overlay g-transition--ease-in g-transition-0_2 g-transform-scale-1_03--hover js-animation fadeInUp landing-card g-bg-primary-opacity-0_9--after',
				],
				'.landing-block-node-title' => [
