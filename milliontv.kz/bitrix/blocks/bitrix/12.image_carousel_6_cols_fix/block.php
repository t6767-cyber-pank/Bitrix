        ...
        <div class="container">
            ...
            <div class="js-carousel row"
				 ...
				 data-init-classes-exclude='[{
					 ...
					 "class": "col-12 col-sm-3 col-lg-2 justify-content-center"
				   }, {
					 "selector": ".js-carousel",
					 "class": "row"
				   }]'>
                <div class="landing-block-card-carousel-item js-slide g-brd-around g-brd-gray-light-v1--hover g-transition-0_2 g-mx-10 d-flex col-12 col-sm-3 col-lg-2 justify-content-center">
                ...
                <div class="landing-block-card-carousel-item js-slide g-brd-around g-brd-gray-light-v1--hover g-transition-0_2 g-mx-10 d-flex col-12 col-12 col-sm-3 col-lg-2 justify-content-center">
					<a href="#" class="landing-block-card-logo-link">
